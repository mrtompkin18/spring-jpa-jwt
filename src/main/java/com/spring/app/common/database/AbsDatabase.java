...
public abstract class AbsDatabase {
    ...
    protected <T> PaginationModel<T> queryForListPagination(String SQLStatement, String SQLCountStatement, MapSqlParameterSource sps, PageRequestModel page, Class<T> mappedClass) throws ApiException {
